param(
  ...
  [string]$ProjectRoot = 'C:\Users\Public\KVSkillPractice\local_acceptance_projects',
  ...
  [string]$KvsExe = '',
  [string]$OutDir = ('C:\Users\Public\KVSkillPractice\local_acceptance_' + (Get-Date -Format 'yyyyMMdd_HHmmss')),
