...
if (-not $VmScriptPath) {
  $VmScriptPath = 'C:\Users\Public\KVSkillPractice\tools\kvstudio\' + [IO.Path]::GetFileName($LocalScriptPath)
}
...
run_root = r"C:\Users\Public\KVSkillPractice\vm-103\interactive_runs" + "\\" + task_name
