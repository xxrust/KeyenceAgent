...
try {
  ...
  Invoke-KvGuardedSendKeys -TargetHwnd $process.MainWindowHandle -Step 'mnm export save S' -Keys 's' -ExpectedTitleLike 'KV STUDIO*' -Action 'S starts mnemonic-list export' -SleepMs 700
